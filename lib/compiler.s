...
| ExpandedExpr = macroexpand ExprWithDeps (table 100)
| CFile = "[Dst].c"
...
symta BaseDir =
| let GRootFolder "/Users/nikita/Documents/git/symta/"
      GSrcFolders [BaseDir "[GRootFolder]lib/"]
  | CacheFolder = "[GRootFolder]cache/test/"
  | let GDstFolder "[CacheFolder]lib/"
        GLibFolder "[GRootFolder]lib/"
    | RuntimeSrc = "[GRootFolder]/runtime/runtime.c"
    | let GHeaderTimestamp (file_time "[GRootFolder]/runtime/runtime.c")
      | RuntimePath = "[CacheFolder]run"
